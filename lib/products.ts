...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: 'Soin du Regard',
    type: 'Technologie iQLED · Luminothérapie & Fermeté',
    price: '259,99 €',
    rawPrice: 259.99,
    description: 'Este producto trata todas las imperfecciones faciales, dejándote con un aspecto más fresco y juvenil. Equipado con tecnología iQLED desarrollada en colaboración con dermatólogos a base de luz infrarroja profunda (830 nm), luz roja (630 nm) y luz azul (415 nm) para una cobertura uniforme y descongestión instantánea.',
    image: '/mascara-luz-led-1.webp',
    images: [
      '/mascara-luz-led-1.webp',
      '/mascara-luz-led-2.webp',
      '/mascara-luz-led-3.webp',
      '/mascara-luz-led-4.webp',
      '/mascara-luz-led-5.webp',
    ],
    media: [
      { url: '/mascara-luz-led-1.webp', type: 'image' },
      { url: '/mascara-luz-led-2.webp', type: 'image' },
      { url: '/mascara-luz-led-3.webp', type: 'image' },
      { url: '/mascara-luz-led-4.webp', type: 'image' },
      { url: '/mascara-luz-led-5.webp', type: 'image' },
    ],
    tag: 'Innovation Beauté · 259,99€',
    rating: 5.0,
    reviewsCount: 38,
  },
  {
    ...
    price: '158,00 €',
    rawPrice: 158.00,
    description: 'AGE-R Booster Pro - Negro | Dispositivo K‑Beauty con efecto vidrio luminoso para una piel radiante y confort facial. Cuenta con 4 modos de alta tecnología con potencia 2X superior: Modo Booster X2 para luminosidad, Modo MC X2 para relleno, Modo Derma Shot X2 para definición facial y Modo Air Shot X2 para afinar los poros.',
    image: '/age-r-booster-pro-1.webp',
    images: [
      '/age-r-booster-pro-1.webp',
      '/age-r-booster-pro-2.webp',
      '/age-r-booster-pro-3.webp',
      '/age-r-booster-pro-4.webp',
      '/age-r-booster-pro-5.webp',
    ],
    media: [
      { url: '/age-r-booster-pro-1.webp', type: 'image' },
      { url: '/age-r-booster-pro-2.webp', type: 'image' },
      { url: '/age-r-booster-pro-3.webp', type: 'image' },
      { url: '/age-r-booster-pro-4.webp', type: 'image' },
      { url: '/age-r-booster-pro-5.webp', type: 'image' },
    ],
    tag: 'K-Beauty Élite · 158€',
    rating: 5.0,
    reviewsCount: 47,
  },
]
